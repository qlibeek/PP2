...
mainclock = pygame.transform.scale(pygame.image.load(r"C:\Users\burak\OneDrive\Изображения\base_micky.jpg"), (800, 600)).convert_alpha()
leftarm = pygame.image.load(r"C:\Users\burak\OneDrive\Изображения\minute.png").convert_alpha()
rightarm = pygame.image.load(r"C:\Users\burak\OneDrive\Изображения\second.png").convert_alpha()
